...
- **Defense:** one die by default; no limit once you have made a melee attack this round (any foe). Hostile magic has no limit. **Guard** gives Fuel dice to an ally's Defend (1, or up to 2 with a shield). **Cover** answers missiles and hostile magic with a free cover die, rolled live (+1 Fuel, or +2 with a shield); a shield is not itself Cover. Roll the cover die: 6 Sparks the hit onto the cover, 1 does nothing, 2–5 shaves the blow by its face.
