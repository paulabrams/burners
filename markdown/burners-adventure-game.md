...
- **Manage:** Boss Action — one company hand uses half round **up** that round instead of down. See [[Burners Company]].
...
- **Fuel:** the dice from your Initiative rolls, kept at their faces and spent through the fight to attack, defend, cast, and riposte. From round 2 on, Roll Initiative refills one die per character level into the pool. Remove spent Fuel dice from play, they are "burned".
...
- **Block:** spend an attack and "block!" an attack aimed at an adjacent ally, interposing yourself between them and the attack. The attack redirects to you; defend it normally. You are "taking a hit for the team". See Fighting.
...
| **Heart** (Boss) | 80 gp | **11 physical + 1 Company**; one **henchman** seated (level 1, Sword 1 or Craft 1, half power); basic gear, keep and a share of the take (see [[Burners Company]]) |
...
- **Boss** (Heart, 80 gp): a spear 3, leather armor (AC 1) 20, and coin held to outfit or bankroll the henchman. **11 physical + 1 Company** — starter henchman seated (level 1, Sword or Craft, half power). A leader spends on their people. You may not re-Muster until your first sleep or first real job outfit.
...
- **Monsters:** award XP by Hit Dice when a foe is overcome (killed, routed, or otherwise neutralized as treasure). A 1 HD skeleton is 10 XP; a ~4 HD boss is 125. Divide among **PCs** plus any **unslotted** retainers/henchmen who delved (those hands earn none of their share — pure suck). Hands in **Company seats** are off the divisor. The Referee has the full Hit Dice table.
- **Treasure:** **1 XP per 1 gp** of coins, gems, and jewelry **recovered to safety**, banked in town, not merely pocketed in the delve. Loot you cannot haul home is not loot yet. Goods, art objects, and equipment count at their sale value when sold. The Referee sets the number once. Same divisor rules.
...
**Company and XP.** Only a Boss can Muster. Unslotted delving retainers suck XP; Mustering stops the suck. Mustered henchmen who survive gain **bonus XP**: half of the **Boss's** award, split among those henchmen — not taken from anyone. See [[Burners Company]].
...
| Heart | Boss | **Muster** (seats stop XP suck; henchman bonus XP); Morale for hirelings/retainers; **Manage** (Action → half round up) |
...
**The Boss's command (Heart 1+).** As a Veteran you rule the melee. As a Journeyman, the journey. As a Sorcerer, the unseen. As a Boss, the company. Heart unlocks **Muster**: you split your twelve into physical kit and **Company** seats, and seat today's crew (each hand costs Company slots equal to their Handling, 1–4). There is no Heart hard-cap on how many seats you declare within the twelve — the packing cost and Handling are the tax. Your Heart steadies nerve (**Morale Check:** `2d6 + Heart`) for hirelings and retainers. Spend your **Action** to **Manage** one hand and they use half round **up** that round. **Unslotted** retainers dilute XP; **Mustered** hands do not. Mustered henchmen who survive gain **half your award as bonus XP**. They do not check Morale while you are active. **Any delver** can hire for coin — without Muster, delving retainers always suck XP. Full rules: [[Burners Company]].
...
- **Mara**, Heart 1 (Boss). "Pays in coin and reputation. Collects both."
  ...
  - 5 HP and leather (AC 1). Split: **11 physical + 1 Company** — Nell seated (level 1 Sword, half power; Handling 1 until first pressure).
  ...
  - Henchman: **Nell** — level 1, Sword 1, Traits *spear* and *steady under fire*, HP ⌊1d6/2⌋ (min 1); climbs on half Mara's XP when Mustering; see [[Burners Company]].
...
Anyone with coin can hire a torchbearer or a sellsword. A **Boss (Heart 1+)** **Musters** today's crew: declare a **physical / Company** split of the twelve and seat hands into Company slots. Each person costs **Company slots equal to their Handling (1–4)**. There is no Heart hard-cap on seats within the twelve — packing cost and Handling are the tax. Heart steadies nerve (`2d6 + Heart` on a Morale Check for hirelings and retainers). Spend your Action to **Manage** one hand (half round up that round). **Unslotted** retainers dilute XP; **Mustered** hands do not. Mustered henchmen also take **half the Boss's award as bonus XP**.

Starting Boss: **11 physical + 1 Company**, starter henchman seated (level 1, Sword or Craft). Re-Muster before a job or on any 8-hour sleep.

Hirelings, retainers, henchmen, half power, Manage, Morale, and example hands: **[[Burners Company]]**.
