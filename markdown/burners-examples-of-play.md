...
- Wandering check: d6 = **1** — encounter. Cellar denizens, hostile by writ: **4 grave-rats** (HD 1, 5 HP each, bite d6 → 2 slots).
...
- **Kragg** attacks: burns a 5 → rat 1 (5 HP) reaches 0: **Cracked!** He burns a 6 to strike a **Spark**, then Fuels it with a 2 for a second attack → the finishing blow drops rat 1.
- **Brand** attacks: burns a 5 → rat 2 is **Cracked!** (no Fuel refill from here).
- **Ilsa** (spear) attacks: burns a 4 → the Cracked rat drops.
- **Rats** act: rats 3 and 4 bite Sefa. She Defends the first 3 with a 4. Against the second 4, leather soaks 1 first; she burns a 3 to cut the rest. Zeroed.

**Round 2.**

- **Kragg** cracks rat 3 with one blow and finishes it with his second. **Brand** cracks rat 4; **Ilsa** finishes it. Threat overcome → **vent 2 → Heat 6.**

*Note: each 5-HP rat took one blow to Crack and another to finish. A swarm's teeth are its count of attacks, not any one blow — and a Burner's armor soaks each blow separately, so numbers grind rather than spike.*
...
- **Wight**, two grave-sword blows:
  - → **Brand**: 3 dice (6,5,4 = 15). Brand's leather soaks 1 first → 14. He has not meleed this round → one die: burns a 6 → **8 to HP.** Brand 5 → **−3: a Wound** (severity 3). Location 1d6=2, **torso, winded** — loses a Fuel die. **Shock Check: 2d6 + Sword (0) = 8 vs severity 3** ✓ — keeps his feet. *(Brand Fuel 7→5.)*
  - → **Ilsa**: 2 dice (5,5 = 10). Her leather soaks 1 first → 9. She has not meleed → one die: burns a 4 → **5 to HP.** Ilsa HP 3 → **−2: a Wound** (severity 2). Location 1d6=4, an **arm** — the spear-arm hangs useless until she reaches full HP. **Shock Check: 2d6 + Sword (0) = 6 vs severity 2** ✓ — she keeps her feet, shaken, one-armed. *(Fuel 8→7.)*
  - *(Wight burned 5 dice attacking; 9 left.)*
- **Kragg** attacks the wight (Veteran, two blows; 2-handed axe, 4 slots → two dice a blow) — having meleed, he Defends without limit for the rest of this round:
  - Blow A: 6,5,4 = 15. Resistance 5 leaves 10. Wight has already meleed this round, so Defends freely: burns a 6 → **4.** Wight **15 → 11.**
...
- **Wounds:** Ilsa sits at **−2 HP** (severity 2) with a dead arm; Brand at **−3** (severity 3) winded. After the fight, allies **help**; each makes **`2d6 + Craft` vs severity** (or die). Helped and passed: **1 HP per day** with food until **full HP**, then the Wound closes. Hour Rest does nothing while Wounded. Ilsa may spend a sleep-recovery card to untap *Adhere*.
...
- **Damage is the faces of burned dice**, minus a Burner's armor AC or a monster's Resistance, then minus the defender's burned Fuel dice. A blow is one die; a weapon of 3+ slots wielded in two hands can add a second. Monsters have no AC. Monsters at **0 down to −Max HP** are **Cracked!** (no Resistance, no Fuel refill; next damaging hit finishes). **Past −Max HP** they are **Splatted!**
- **Defense:** melee 1 die (no limit once you have meleed this round); missile 1 die (2 with Cover); magic no limit. **Block** spends one melee attack to redirect a blow onto yourself. **Cover** lets you burn 2 vs a missile; Fuel a Spark while using a melee foe as Cover to dump the shot into them.
- **The Wound model:** see [[Burners Principles#HP is plot armor; past 0 it gets real]].
- **Casting is the same economy:** Ilsa's *Adhere* was one Action, one Fuel die rolled for the **cast total**; the card **tapped**; the wight Defended with a die of its own and ate the **overrun** as control — sword-arm stuck, no HP lost. Hostile utility burns the same Fuel pool as steel, and lives in the effect lane. Sleep recovers up to Sorcerie Level cards.
- **Resistance vs the named weakness:** the wight's Resistance 5 (grave-cold and the byrnie as one wall) made mundane steel almost useless, while silver ignored the Resistance (Sefa). Sorcery did not chip the Resistance at all — it took the monster's arm out of the exchange so the fighters could finish. **Sorcerers solve; fighters kill.**
- **The monster's slot/Fuel economy cuts both ways:** the wight burned its huge pool attacking and Defending, so by Sefa's turn it could spare only a die or two. Tie up its dice — or its arm — then land the answer.
- **Nobody died.** Shock kept them combat-effective; help after the fight bought the Craft survival checks. That is what a clean job looks like.
...
| **Sharper** (HD 1; Illusione hand; *Bewitch* ready) | 1 HD + 6 Heat (enemy side, once) | **7** |
...
- **Kragg** (Veteran, two attacks; the axe stays sheathed — this is a tavern) burns a held 6 to strike a **Spark**, then Fuels it with 5,4 to **Man-handle** — heaves the table into the sharper. Force 9; the sharper Defends 4,2 = 6 → bowled over, **in the dirt**, and his concentration goes with his footing — but the working is already in the air; it resolves on his turn. He spends one of his Veteran attacks to **Block** for Brand: if a blow comes for Brand, it redirects onto Kragg. *(Kragg 5→2 dice; order stays locked.)*
- **Sharper** (from the floor) finishes the cast — *Bewitch* (Illusione 1, ready in hand): burns 1 Fuel die = **5**. **Cast total 5.** The card taps. Brand may Defend — but **Ilsa is adjacent and Wards**: Sorcerie 1, she burns **1** Fuel die (a 4), cutting the cast to **1**. **Brand then Defends** with 1 die (a 3) → fully defended. No charm, no HP. *(Ilsa 6→5; Brand 5→4; sharper 7→6.)*
- **Ilsa** (her Action still unspent — Ward is not a turn): casts *Adhere* from her hand at the sharper. 1 die = **6** — cast total 6, and the 6 is a **Spark**. The card taps. The sharper, in the dirt and rattled, Defends with 2 dice: 3,2 = **5**. **Overrun 1** — his casting hand sticks to the floorboards (effect lane, **no HP**; he stays at 5). She Fuels the Spark with another die and burns it on the working itself: the Referee lets the glue catch his other wrist as well — no ready cards until he washes free. *(Ilsa 5→3; sharper 6→4.)*
- **Bravo 1** lunges at Sefa, knife out: 1 die = **4**. Sefa has not meleed this round → one die: burns a 3 → 1 through, no armor tonight → **Sefa 3 HP → 2.** *(Sefa 5→4.)*
...
- **The take:** 350 gp, one confiscated **ring** (Wizard Drip find; no bonus cards), and a bravo's knife in the floorboards.
...
- **Control is effect-only:** see [[Burners Principles#Harm and effect are separate lanes]]. Had the charm landed, Brand loses no HP — the crew attacks the reason (concentration, hand, skin).
