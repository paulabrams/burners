---
layout: default
title: "Burners Referee Magic Items"
hero: /images/albert-robida-pd/knight-returning-with-pig-and-keg.jpg
hero_alt: "A knight returns laden — Albert Robida"
---
...
Mundane quality — **Common**, **Fine steel**, **Signature** — lives in [[Burners Arms and Armor]]. These rungs are magical (or magic-adjacent) and live only here:
...
**Shields and armor** use the same ladder: a +2 heater is enchanted plus a +1-tier power and a +2-tier power; +1 chain is enchanted plus one +1-tier power. Do not raise AC or size for the plus — the powers carry the rest.

---

## OSE conversion (magic arms)

Potions, rings, cursed items, and wondrous items port as written in [[Burners OSE Conversions]]. **Magic arms, shields, and armor** convert only by this page.
...
2. **Bane vs type** — *"+2 vs lycanthropes"*, *"+3 vs undead"* → a +1-tier or +2-tier power that **is the right tool** (or reads as silver) vs that quarry — not a bigger number.
...
| 7 | Holy water etched inside — once/session, fire as the right tool vs undead (see [[Burners Burn Undead]]) |
...
| 7 | **Silvered** — one location (gauntlets, gorget) counts as silver (right tool vs silver-weak) |
...
| 10 | **Anti-magic weave** — **soak 1** vs hostile magic where covered (Burner AC-like) |
...
| **5** | **Tuned** — to a dead hand. Re-tune to wake it. |
| **6** | **Signature** — a name, a history, a hook. Fine steel beneath. |
| **7** | **Fine steel, plain and true** — Trusty, and it sells dear. |
| **8** | **Signature.** |
| **9** | **Tuned** — to a dead hand. |
| **10** | **An unusual tag** for its type. |
| **11** | **Bane-forged.** |
| **12** | **A relic all along.** |
...
**Mundane fine make** on armor becomes a **fitted Signature harness** — comfortable, quiet, worth coin, never hinders. **+n armor or shields** never raise AC or size for the plus.
